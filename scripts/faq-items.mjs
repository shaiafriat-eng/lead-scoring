...
export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: "Yes. Behavioral Score Calculation is reduced in specific ops scenarios: Blacklisted country, Not Relevant, Unsubscribe, or Nurture → 0 points by default. For Nurture, these reasons keep a residual score instead — Migration or Unresponsive → 10; Changes in personnel or No internal capacity → 20. Demographic grade (A–D) can also worsen when account or persona data changes. After a reduction, the lead must earn new engagement before reaching the 100-point MQL threshold again. See MQL Policy → When the behavioral score is reduced.",
  },
  {
